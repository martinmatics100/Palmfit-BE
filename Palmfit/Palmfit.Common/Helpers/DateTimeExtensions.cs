...
namespace Axxess.PalliativeCare.Common.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        //public static DateTime StartOfWeek(this DateTime dt, MedicareWeek startOfWeek)
        //{
        //    return StartOfWeek(dt, (DayOfWeek)startOfWeek);
        //}
        ...
        {
            if (utcTime.HasValue && !string.IsNullOrEmpty(timeZone))
            {
                ...
                return new ZonedDateTime(Instant.FromDateTimeUtc(DateTime.SpecifyKind(utcTime.Value, DateTimeKind.Utc)), dateTimeZone)
